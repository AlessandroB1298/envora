...
const CopyContainer: React.FC<CopyContainerProps> = ({ copyText }) => {
  ...
  return (
    <div className="mt-2 flex flex-row items-center justify-between rounded-xl shadow-md border border-white h-[5vh] bg-gray-700/30">
      ...
      <Copy
        ...
        className="mr-3 hover:cursor-pointer hover:text-gray-100"
      />
    </div>
  );
};
