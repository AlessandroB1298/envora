...
export const basicComponent = '"use client"' + '\n'
  + 'import { useGSAP } from "@gsap/react";' + '\n'
  + 'import { gsap } from "gsap";' + '\n'
...
export const basicWelcomeCode = 'import { BasicGsapAnimation } from "./basicAnimation";' + '\n'
  + '' + '\n'
  + '' + '\n'
  ...
  + '      <h2 className="bg-white bg-gradient-to-br from-blue-800 to-white bg-clip-text text-transparent text-4xl font-bold ">to the</h2>' + '\n'
