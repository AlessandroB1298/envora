        ...
        <section className=" grid grid-cols-2 text-left mt-3 ">
          <h1 className=" flex flex-col  text-gray-100 font-bold mb-2">
            ...
            <div className="flex flex-wrap gap-4 mt-10">
              <Link className="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-all" href={"/"}>
                Get Started
              </Link>
              <Link className="px-6 py-3 bg-gray-800 hover:bg-gray-700 text-gray-100 rounded-lg font-medium transition-all border border-gray-700" href={"/dashboard/docs"}
              >
                Documentation
              </Link>
            </div>
