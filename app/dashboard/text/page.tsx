  ...
  return (
    <div className=" ml-[25vw] space-y-6 h-[100vh] ">
      <section className=" flex flex-col mt-5">
        <div className="gap-2">
          <h2 className="text-4xl font-extrabold bg-gradient-to-br from-blue-300 to-white bg-clip-text text-transparent ">Texts & Layouts</h2>
